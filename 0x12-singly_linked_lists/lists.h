...
size_t list_len(const list_t *h);size_t list_len(const list_t *h);
list_t *add_node(list_t **head, const char *str);listint_t *add_nodeint(listint_t **head, const int n);
list_t *add_node_end(list_t **head, const char *str);listint_t *add_nodeint_end(listint_t **head, const int n);
